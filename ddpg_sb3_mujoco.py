...
eval_env = gym.make('HalfCheetah-v5', render_mode='human')  # For evaluation with rendering
...
eval_callback = EvalCallback(
    eval_env=eval_env,
    best_model_save_path='./ddpg_halfcheetah_best_model/',
    log_path='./ddpg_halfcheetah_eval_logs/',
...
model.save("ddpg_halfcheetah_0206")
